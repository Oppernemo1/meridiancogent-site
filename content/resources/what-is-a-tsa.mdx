...
For the operating plan behind the exit date — the service catalogue, the month-by-month sequence, and the acceptance matrix per service — see [The TSA Exit Plan Workbook](/resources/guides/tsa-exit-plan-workbook).
