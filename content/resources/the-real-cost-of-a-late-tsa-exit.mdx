...
{/* TEMP substitute: this CTA belongs in tsa-exit-plan.mdx, which is not published yet. Once it is, move this link there and reconsider whether it still belongs here too. See SITE-BUILD-MANUAL Part 4. */}

The structure for building that discipline into a plan is in [The TSA Exit Plan Workbook](/resources/guides/tsa-exit-plan-workbook).
