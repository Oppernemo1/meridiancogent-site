      ...
      <section aria-labelledby="absence-heading" className="py-20 md:py-32">
        <Container>
          <div className="max-w-measure">
            ...
            <p className="mt-5 text-body-lg leading-relaxed text-ink">
              The same logic governs everything on this page. An empty state
              that says &ldquo;not enough data&rdquo; is more useful than a
              confident number assembled from too little.
            </p>
          </div>
        </Container>
      </section>
